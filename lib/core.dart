...
final Map<String, dynamic>? rawJson;  // ✅ جديد: يحفظ JSON الأصلي للسلاسل
Movie(
...
?.map((e) => Map<String, String>.from(e))
.toList(),
rawJson: (m['raw_json'] as Map?)?.cast<String, dynamic>());  // ✅ جديد
}
/* ======== البحث الذكي ======== */
class Search {
